...
from include.analysis import data_analysis as ranking
#from include.main import ranking
from include.networks.network import import_network
from include.simple_model.data_processing import simple_model_data
...
def build_vectorizer():
    ...
    doc = data_processing.load_doc(data_read_home + '/results_20130124.token', encoding="utf8")
    descriptions = data_processing.load_descriptions(doc, first_description_only=False)
    data_processing.clean_descriptions(descriptions, min_word_length=3)
...
def caption_to_caption_feature(caption=caption_string):
    ...
    descriptions = simple_model_data.load_descriptions(caption, first_description_only=False)
